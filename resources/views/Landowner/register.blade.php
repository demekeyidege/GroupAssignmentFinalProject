...
="gender">female
 ...
 <div class="col-md-6">
 <input id="city" type="text" class="formcontrol @error('city') isinvalid @enderror" name="city" value="{{ old('city') }}" required autocomplete
="city">
 @error('City')
 <span class="invalid-feedback" role="alert">
 <strong>{{ $message }}</strong>
...
="occupation">
 ...
 <div class="col-md-6">
 <input id="Rdate" type="date" class="formcontrol @error('Rdate') isinvalid @enderror" name="Rdate" value="{{ old('Rdate') }}" required autocomplete
="Rdate">
 ...
 <div class="col-md-6">
 <input id="serviceType" type="text" class="formcontrol @error('serviceType') isinvalid @enderror" name="serviceType" value="{{ old('serviceType') }}" required autocomplete
="serviceType">
 @error('Service_Type')
 <span class="invalid-feedback" role="alert">
 <strong>{{ $message }}</strong>
 ...
 <div class="col-md-6">
 <input id="southbondery" type="text" class="formcontrol @error('southbondery') isinvalid @enderror" name="southbondery" value="{{ old('southbondery') }}" required autocomplete
="southbondery">
 @error('South_bondery')
 <span class="invalid-feedback" role="alert">
 <strong>{{ $message }}</strong>
 ...
 <div class="col-md-6">
 <input id="eastbondery" type="text" class="formcontrol @error('eastbondery') isinvalid @enderror" name="eastbondery" value="{{ old('eastbondery') }}" required autocomplete
="eastbondery">
 @error('East_bondery')
 <span class="invalid-feedback" role="alert">
 <strong>{{ $message }}</strong>
 ...
 <div class="col-md-6">
 <input id="northbondery" type="text" class="formcontrol @error('northbondery') isinvalid @enderror" name="northbondery" value="{{ old('northbondery') }}" required autocomplete
="northbondery">
 @error('North_bondery')
 <span class="invalid-feedback" role="alert">
 <strong>{{ $message }}</strong>
 ...
 <div class="col-md-6">
 <input id="westbondery" type="text" class="formcontrol @error('westbondery') isinvalid @enderror" name="westbondery" value="{{ old('westbondery') }}" required autocomplete
="westbondery">
 @error('West_bondery')
 <span class="invalid-feedback" role="alert">
 <strong>{{ $message }}</strong>
 ...
 <div class="col-md-6">
 <input id="area" type="text" class="formcontrol @error('area') isinvalid @enderror" name="area" value="{{ old('area') }}" required autocomplete
="area">
 @error('Area')
 <span class="invalid-feedback" role="alert">
 <strong>{{ $message }}</strong>
 ...
 <div class="col-md-6">
 <input id="parcelcode" type="text" class="formcontrol @error('parcelcode') isinvalid @enderror" name="parcelcode" value="{{ old('parcelcode') }}" required autocomplete
="parcelcode">
 @error('parcel_code')
 <span class="invalid-feedback" role="alert">
 <strong>{{ $message }}</strong>
 ...
 <div class="col-md-6">
 <input id="landlavel" type="text" class="formcontrol @error('landlavel') isinvalid @enderror" name="landlavel" value="{{ old('landlavel') }}" required autocomplete
="landlavel">
 @error('Land_level')
 <span class="invalid-feedback" role="alert">
 <strong>{{ $message }}</strong>
